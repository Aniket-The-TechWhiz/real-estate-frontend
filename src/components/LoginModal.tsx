...
import { X, User, Phone, Home, MapPin, AlertCircle } from 'lucide-react';
import { leadService } from '../services/leadService';
import { LoadingAnimation, CircularSpinner } from './LoadingAnimation';
...
export function LoginModal({ onClose, onSubmit, propertyTitle, propertyId, loading = false }: LoginModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/30 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      {loading ? (
        <LoadingAnimation fullScreen message="Loading form details..." />
      ) : (
